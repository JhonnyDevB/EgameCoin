...
#if defined(NDEBUG)
# error "EGame cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "EGame Signed Message:\n";
...
{
    static int64_t nRewardCoinYear = 90 * CENT;  // creation amount per coin-year [250% Starting | ~5000% Peak]
